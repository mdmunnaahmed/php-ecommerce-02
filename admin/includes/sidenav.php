                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class=" ">
                        <a href="manage-brand.php">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Manage Brands</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                </ul>
                ...
                <ul class="pcoded-submenu">
                    <li class=" ">
                        <a href="add-banner.php">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Add Banner</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li>
                    <li class=" ">
