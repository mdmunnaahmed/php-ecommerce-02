...
$products = $obj_adminBack->countProducts();
$product_count = mysqli_num_rows($products);

$categories = $obj_adminBack->countCategory();
$categroy_count = mysqli_num_rows($categories);
?>
    ...
    <div class="col-md-6 col-xl-3">
        <div class="card bg-c-blue order-card">
            <div class="card-block">
                ...
                <h2 class="text-right"><i class="ti-shopping-cart f-left"></i><span><?php echo $product_count ?></span></h2>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-xl-3">
        <div class="card bg-c-green order-card">
            <div class="card-block">
                ...
                <h2 class="text-right"><i class="ti-tag f-left"></i><span><?php echo $categroy_count; ?></span></h2>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-xl-3">
